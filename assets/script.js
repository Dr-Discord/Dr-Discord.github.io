...
setTimeout(() => {
  ...
  <div>
    ...
    <a href="https://github.com/Dr-Discord/DrDiscord">
      <svg width="34" height="34" viewBox="0 0 5 5" style="transform: translate(23px,-16px) rotate(180deg);z-index: 100">
        <path d="M0 0C-33.347 0-60.388-27.035-60.388-60.388-60.388-87.068-43.085-109.704-19.091-117.689-16.073-118.248-14.965-116.379-14.965-114.784-14.965-113.345-15.021-108.587-15.047-103.541-31.847-107.194-35.392-96.416-35.392-96.416-38.139-89.437-42.097-87.58-42.097-87.58-47.576-83.832-41.684-83.909-41.684-83.909-35.62-84.335-32.427-90.133-32.427-90.133-27.041-99.364-18.3-96.695-14.854-95.152-14.311-91.25-12.747-88.585-11.02-87.077-24.433-85.551-38.533-80.372-38.533-57.233-38.533-50.641-36.174-45.254-32.311-41.025-32.938-39.503-35.005-33.361-31.725-25.043-31.725-25.043-26.654-23.421-15.115-31.234-10.298-29.896-5.132-29.225 0-29.201 5.132-29.225 10.302-29.896 15.128-31.234 26.654-23.421 31.718-25.043 31.718-25.043 35.005-33.361 32.938-39.503 32.311-41.025 36.183-45.254 38.525-50.641 38.525-57.233 38.525-80.428 24.398-85.534 10.951-87.029 13.117-88.903 15.047-92.578 15.047-98.212 15.047-106.292 14.978-112.795 14.978-114.784 14.978-116.392 16.064-118.275 19.125-117.682 43.107-109.688 60.388-87.06 60.388-60.388 60.388-27.035 33.351 0 0 0" fill="currentcolor" style="transform: scale(0.04) translate(60px,125px);">
        </path>
      </svg>
    </a>
  </div>
  <div>
    ...
    <div>
      <a href="/plugins/">Plugin's
      </a>
    </div>
    <div>
      <a href="/themes/">Theme's
      </a>
    </div>
    <div>
      <a href="/features/">Feature's
      </a>
    </div>
    <div>
